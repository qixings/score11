...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector('.games-section .game:nth-child(3)').addEventListener('click', redirectToSnake); // Added Snake game
    document.querySelector('.games-section .game:nth-child(4)').addEventListener('click', redirectToColortrading);
